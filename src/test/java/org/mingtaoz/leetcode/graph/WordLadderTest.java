...
public class WordLadderTest extends TestCase {
	...
	public void testNeighbours2() {
		...
		dict.add("abd");
		String s = "abc";
		assertTrue("abe".equals(sut.neighbours(s, dict).get(0))
				|| "abd".equals(sut.neighbours(s, dict).get(0)));
		assertTrue("abe".equals(sut.neighbours(s, dict).get(1))
				|| "abd".equals(sut.neighbours(s, dict).get(1)));
	...
	public void testFindLadders3() {
		sut = new WordLadder();
		String[] dictArray = { "kid", "tag", "pup", "ail", "tun", "woo", "erg",
