...
public class SumTest {
	...
	@Test
	public void test4Sum3() {
		ASSERT.that(sut.fourSum(new int[] { -1, -1, 0, 0, 1 }, 0)).iteratesAs(
				Arrays.asList(Arrays.asList(-1, 0, 0, 1)));
	}

	@Test
	public void test4Sum2() {
		ASSERT.that(
				sut.fourSum(new int[] { 91277418, 66271374, 38763793, 4092006,
						...
						-86235407, 3164123, 8956697, -9003909, -18929014,
						-73824245 }, -236727523)).iteratesAs(
				Arrays.asList(Arrays.asList(-79583480, -70078020, -65863359,
						-21202664), Arrays.asList(-76072023, -59608044,
						-58094433, -42953023)));
	}

	@Test
	public void test4Sum1() {
		ASSERT.that(sut.fourSum(new int[] { 1, -2, -5, -4, -3, 3, 3, 5 }, -11))
				.iteratesAs(Arrays.asList(Arrays.asList(-5, -4, -3, 1)));
	}

	@Test
	public void test3Sum1() {
		ASSERT.that(sut.threeSumClosest(new int[] { 1, 1, 1, 0 }, -100)).is(2);
	}
